...
Acceptance: direct URL loads building info. Lint+build clean. Append `FRONT-DONE: BUILDING-DETAIL-P1 — BuildingDetailPage with gallery + metadata + back. <N> files. lint/build clean.` to .codex/Task.md § Handoffs.
