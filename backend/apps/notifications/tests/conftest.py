"""
conftest.py -- pytest fixtures for notifications app tests.

Mirrors the pattern in apps/social/tests/conftest.py so that notifications
tests can be run in isolation or as part of the full suite.
"""
import os
