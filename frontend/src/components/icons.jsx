 ...
 * All icons: 24 viewBox, fill=none, currentColor, round caps, stroke-width 1.5.
 */
const base = {
  viewBox: '0 0 24 24',
  fill: 'none',
...
export const IconShare = (p) => (
  <svg {...base} {...p}><circle cx="6" cy="12" r="3" /><circle cx="18" cy="6" r="3" /><circle cx="18" cy="18" r="3" /><path d="M8.6 10.5l6.8-3M8.6 13.5l6.8 3" /></svg>
)
