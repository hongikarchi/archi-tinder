/**
 * components/GoogleVerifyButton.jsx
 ...
 * Encapsulates the hook so VerifyGateModal never calls useGoogleLogin unconditionally.
 */
...
/**
 * Props:
 *   onSuccess       (codeResponse) => void
 *   onError         (errorResponse) => void
 *   onNonOAuthError (err) => void
 *   disabled        bool
 *   loading         bool
 */
export default function GoogleVerifyButton({ onSuccess, onError, onNonOAuthError, disabled, loading }) {
