...
export const QUESTIONS = [
  ...
  { id: 1, axis: 1, reversed: false, text_ko: '건축에서 이론적 완성도보다 실제 시공 가능성을 더 중요하게 생각한다.' },
  ...
  { id: 16, axis: 5, reversed: true,  text_ko: '결정 전에 충분한 정보를 수집하고 분석한다.' },
  { id: 17, axis: 5, reversed: false, text_ko: '영감이 떠오르면 바로 스케치하거나 시작한다.' },
  { id: 18, axis: 5, reversed: true,  text_ko: '계획 없이 시작하면 불안하다.' },
  { id: 19, axis: 5, reversed: false, text_ko: '즉흥적으로 결정한 것이 오히려 더 잘 맞을 때가 많다.' },
]
