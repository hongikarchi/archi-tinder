 ...
 */
// Reporter: Mermaid sources may be stale — commit 16e2a1a decomposed engine.py into engine_{vecmath,convergence,filters,cards}.py (pure move; engine.py facade + recommendation core nodes unchanged, so flow stays valid). Optional: surface sibling modules in systemFlow.
window.PROJECT_STATE = {
  meta: {
    name: 'ArchiTinder — Make Web',
    updatedAt: '2026-06-01 14:59 KST',
    head: 'e1ff077',
    branch: 'feature/claude-decompose-engine',
  },

  done: [
    {
      id: 'FULL-REFACTOR-1',
      title: '큰 파일 분해 (engine.py 등) — pure-move 4-slice 분해',
  ...
  prs: [
    ...
    {
      number: 165,
      title: 'feat(sns): ResultsPage UI overhaul — Liked 카드 노출 + 추천 그리드',
      mergedAt: '2026-05-30T23:56:32Z',
      mergedAtKST: '2026-05-31 08:56 KST',
      sha: '61c9ee1',
    },
  ],
